  ...
  return (
    ...
    <div id='download'>
      ...
      <div className='download-container'>
        ...
        <a target="_blank" href='https://observerjs-windows-build.s3.amazonaws.com/obServerJS+Setup+0.1.0.exe'><FontAwesomeIcon id='icon' style={{ height: '8vh', width: 'auto' }} icon={faMicrosoft} /></a>
      </div>
    </div>
